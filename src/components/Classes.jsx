      ...
      <div className="classes-content ">
        ...
        <div className="classes-content flex justify-center items-center min-h-screen">
          <div className="mt-20 flex flex-wrap justify-center gap-6 md:gap-8">
            {/* Card 1 */}
            <div className="mt-36 mb-36 sm:mt-20 sm:mb-0 relative bg-orange-100 shadow-lg rounded-lg w-80 h-auto p-6">
              <div className="absolute -top-32 left-1/2 transform -translate-x-1/2">
                <div className="w-36 h-36 sm:w-56 sm:h-56 rounded-full border-8 border-primary hover:border-orange-500 overflow-hidden shadow-md">
                  <img
              ...
              <div className="top-space mt-20 text-center">
                <h3 className="text-xl sm:text-2xl lobster font-bold">
                  Art & Drawing
                </h3>
                <button className="mt-4 bg-orange-500 text-white py-2 px-4 rounded-full">
                  ₹7,999
                </button>
                <div className="mt-2 flex items-center justify-center gap-4 sm:flex-row sm:justify-center sm:gap-6">
                  <div className="mt-2 ">
